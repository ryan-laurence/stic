function loadEditData(params) {
	var 
		...
		_modalBtnCancel = {
			...
			action: function(dialogItself) {
				...
				modalBody = dialogItself.getModalBody();
				modalBody.find('input[data-field]').prop('disabled', false);
			}
		},
	...
	var newRoleSelectField = function(params) {			
		...
		$.getJSON(_JSONUrl, function(data) { 
			...
			container.append('<select class="form-control" title="-" data-field="role_id">' + options.join('') + '</select>');
